                                ...
                                <div class="cart-items">
                                    ...
                                    <div class="shopping-item">
                                        <div class="dropdown-cart-header">
                                            <span></span><a href="{{route('cart')}}">View Cart</a>
                                        </div>
                                        <ul class="shopping-list">
                                            <li ng-repeat="sp in cart">
                                                <a href="javascript:void(0)" ng-click="removeFromCart($index)" class="remove" title="Remove this item"><i
                                                        class="lni lni-close"></i></a>
                                                <div class="cart-img-head">
                                                    <a class="cart-img" href="/detail/@{{sp.slug}}"><img
                                                            src="@{{sp.image}}" alt="#"></a>
                                                </div>

                                                <div class="content">
                                                    <h4><a href="/detail/@{{sp.slug}}">
                                                        @{{sp.name}}</a></h4>
                                                    <p class="quantity">@{{sp.quantity}}x - <span ng-if="sp.sale_price!=null">@{{sp.sale_price|number}}Đ</span>
                                                       <span ng-if="sp.sale_price==null">@{{sp.price|number}}Đ</span></p>
                                                </div>
                                            </li>
                                        ...
                                        <div class="bottom">
                                            <div class="total">
                                                <span>Total</span>
                                                <span class="total-amount">@{{totalCartMoney() | number}}Đ</span>
                                            </div>
                                            <div class="button">
