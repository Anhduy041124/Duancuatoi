        ...
        <div class="card rounded-0 border-0 shadow-sm mb-4">
          <div class="card-body">
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control rounded-0" name="description" id="description" rows="6"></textarea>
            </div>
            <div class="row">
              <div class="col mb-3">
                <label for="instock" class="form-label">Instock *</label>
                <input type="number" class="form-control rounded-0" name="instock" id="instock" min="0" required>
              </div>
              <div class="col mb-3">
                <label for="category" class="form-label">Category *</label>
                <div class="input-group">
                  <select class="form-select rounded-0" name="category_id" id="category" required>
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col mb-3">
                ...
                <input type="number" class="form-control rounded-0" name="price" id="price" min="0" required>
              </div>
              <div class="col mb-3">
                <label for="sale_price" class="form-label">Sale Price</label>
                <input type="number" class="form-control rounded-0" name="sale_price" id="sale_price" min="0">
              </div>
            </div>
          </div>
        </div>
