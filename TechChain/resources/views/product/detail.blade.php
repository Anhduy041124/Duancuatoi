                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-images">
                            <div id="product-images" class="carousel slide">
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img src="{{$sp->image}}" class="d-block w-100" alt="...">
                                  </div>
                            ...
                            <main id="gallery">
                                <div class="images">
                                    <img data-bs-target="#product-images" data-bs-slide-to="0" src="{{$sp->image}}" class="img" alt="#">
                                    @php $i=1  @endphp
                                    @foreach ($sp->images as $item)
                                    <img data-bs-target="#product-images" data-bs-slide-to="$i++" src="{{$item->image}}" class="img" alt="#">
                                    @endforeach
                                </div>
                            </main>
                        </div>
                        ...
                        <div class="reviews">
                            ...
                            <div ng-repeat="bl in dsBL" class="single-review">
                                ...
                                <div class="review-info">
                                    <h4>@{{bl.user_fullname}}
                                        <span>@{{bl.created_at | date:'dd/MM/yyyy HH:mm:ss'}}</span>
                                    </h4>
                                    <ul class="stars">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" ng-model="content" id="review-message" rows="8" required></textarea>
                    </div>
                </div>
